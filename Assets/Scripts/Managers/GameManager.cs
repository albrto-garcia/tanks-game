...
public class GameManager : MonoBehaviour
{
    ...
    {
        //Timer para poder presentar el título del juego
    ...
    private string EndMessage()
    {
        ...
        if (m_GameWinner != null)
        {
            //Guardo los valores de la vida y de las rondas totales del ganador con el color asignado al mismo.
            string FinalHealth = "<color=#" + ColorUtility.ToHtmlStringRGB(m_GameWinner.m_PlayerColor) +
                                 ">" + Mathf.Round(m_GameWinner.m_Instance.GetComponent<TankHealth>().m_CurrentHealth) + " DE VIDA</color>";
            string TotalRounds = "<color=#" + ColorUtility.ToHtmlStringRGB(m_GameWinner.m_PlayerColor) +
                                 ">" + m_GameWinner.m_Wins + " RONDAS GANADAS</color>";

            message = m_GameWinner.m_ColoredPlayerText + " GANA EL JUEGO CON " +
                      FinalHealth + " Y UN TOTAL DE \n" +
                      TotalRounds + "!";
        }
